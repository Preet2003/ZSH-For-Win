...
We as members, contributors, and leaders pledge to make participation in the WinZSH
...
maintainers via a private channel listed in `SECURITY.md` or repository settings.
